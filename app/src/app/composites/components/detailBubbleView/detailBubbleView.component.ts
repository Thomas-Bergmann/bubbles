...
@Component({
  selector: 'detailBubbleView',
  templateUrl: './detailBubbleView.component.html',
  styleUrls: ['./detailBubbleView.component.sass']
})

export class DetailBubbleViewComponent implements OnInit  {
